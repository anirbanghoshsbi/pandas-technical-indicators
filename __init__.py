from pandas-technical-indicators import technical_indicators as utils

__version__ = '0.0.3'

def moving_average(df, n):
	return utils.moving_average(df, n)

def exponential_moving_average(df, n):
	return utils.exponential_moving_average(df, n)

def momentum(df, n):
	return utils.momentum(df, n)
